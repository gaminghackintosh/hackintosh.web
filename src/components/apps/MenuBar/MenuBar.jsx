...
function SmoothSlider({ initialValue = 50, icon: Icon, endIcon: EndIcon, onValueChange }) {
...
// Иконка Focus (луна)
const FocusIcon = ({ size = 20 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
    <path d="M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.389 5.389 0 0 1-4.4 2.26 5.403 5.403 0 0 1-3.14-9.8c-.44-.06-.9-.1-1.36-.1z"/>
  </svg>
);

// Иконка Sleep (кровать)
const SleepIcon = ({ size = 13 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
...
// Иконка Stage Manager
const StageManagerIcon = ({ size = 15 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
...
// Иконка Screen Mirroring
const ScreenMirroringIcon = ({ size = 15 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
...
// Иконка Display (солнце)
const DisplayIcon = ({ size = 14 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
...
// Иконка Sound (наушники)
const SoundIcon = ({ size = 14 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
    <path d="M12 3v9.28c-.47-.17-.97-.28-1.5-.28C8.01 12 6 14.01 6 16.5S8.01 21 10.5 21c2.31 0 4.2-1.75 4.45-4H15V6h4V3h-7z"/>
  </svg>
);

// Иконка AirPlay (для звука)
const AirPlayIcon = ({ size = 14 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
    <path d="M6 18l6-6 6 6H6zM6 14l6-6 6 6H6zM3 20h18v2H3v-2z"/>
  </svg>
);

// Иконка Music Recognition
const MusicRecognitionIcon = ({ size = 18 }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/>
  </svg>
);

// Иконка Theme (солнце/луна)
const ThemeIcon = ({ size = 18, isLight }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size}>
    {isLight ? (
